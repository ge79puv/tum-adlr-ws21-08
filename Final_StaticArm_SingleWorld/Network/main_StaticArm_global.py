...
save_image = True
plot_path = './plot/arm/test_global/'
...
# =========================== Save the results ========================
print('FINISH.')
torch.save(best_model_weights, "model_arm_global")
np.savez("arm_loss_global.npz", train_loss_history=train_loss_history, train_length_loss_history=train_length_loss_history,
