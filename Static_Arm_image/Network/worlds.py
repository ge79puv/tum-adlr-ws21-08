...
from chompy.GridWorld import obstacle_img2dist_img
from Network.points_dataset import BasePointsDataset
...
class Worlds:
    ...
    def create_worlds(self):
        ...
        self.dist_images = ImagesDataset(self.n_worlds, self.dist_images)  # torch.Size([n_worlds, 1, 64, 64])
    ...
    def create_points_loader(self, n_pairs, batch_size, collision_rate=None, shuffle=True):
        for i in range(self.n_worlds):
            ...
            par = self.pars[str(i)]
            SE = BasePointsDataset(n_pairs, par)
